		...
		<!--Head wrap ends-->
			...
			<div id="form2">
				<form action="" method="post" enctype="multipart/form-data">
					...
					<span style="font-family:tahoma"><p>CHANGE PROFILE IMAGE: </p><input type="file" name="u_image"/><br /><br />
					<br /><input type="submit" name="update_photo" value="Update Profile Image!"><br /><br />	
					
					
					<hr /><p>CHANGE YOUR PASSWORD:</p><br />
                    ...
                    <input type="submit" name="update_pass" value="Update Password!"><br /><br />
...
<option value="Zimbabwe">Zimbabwe</option>
					...
					Birthday: <input type="date" name="birthday" placeholder="yyyy-mm-dd" value="<?php echo $birthday?>"/><br /><br />
					...
					</span><input type="submit" name="update" value="Update Info!">
...
<?php 
	...
	if(isset($_POST['update_pass'])){
	    ...
	    while ($row = mysqli_fetch_assoc($password_query)) {
	        ...
	        if(password_verify($old_password, $row['user_pass'])){
	        
	            //check whether 2 new passwords match
	            if ($new_password == $new_password2) {
	            
	            $hash_password = password_hash($new_password, PASSWORD_BCRYPT, array('cost' => 10));   
	                
                $update = "update user set user_pass = '$hash_password' where user_id='$user_id'";
	...
	if(isset($_POST['update'])){
	    ...
	    $u_country = mysqli_real_escape_string($con, $_POST['country']);
	    $u_birthday = mysqli_real_escape_string($con, $_POST['birthday']);
	    $u_gender = mysqli_real_escape_string($con, $_POST['gender']);
	    
        

		
		$update = "update user set first_name='$f_name', last_name='$l_name', user_country='$u_country', birthday='$u_birthday', user_gender='$u_gender' where user_id='$user_id'";
	...
	if(isset($_POST['update_photo'])){
		...
		$update = "update user set user_image='$u_image' where user_id='$user_id'";
