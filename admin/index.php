...
<body>
	<div class="container">
		...
		<div id="content">
		<h2 style="color:blue; text-align: center; padding: 5px"><?php echo $_GET['welcome']; ?> : Manage your content!</h2>
			<?php
		...
		<div id="foot">
		<h2 style="color: white; padding: 10px; text-align: center;";>Copyrights Facebook 2015</h2>
		</div>
	</div>
</body>
